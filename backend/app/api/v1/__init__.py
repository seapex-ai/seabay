...
api_v1_router.include_router(publications_router, prefix="/publications", tags=["publications"])
api_v1_router.include_router(people_router, prefix="/people", tags=["people"])
