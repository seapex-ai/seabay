...
const SEABAY_TOOLS = [
  {
    ...
    function: {
      ...
      parameters: {
        type: 'object',
        properties: {
          description: { type: 'string', description: 'Natural-language description of what the user needs' },
          skills: { type: 'array', items: { type: 'string' }, description: 'Desired skills or activity types' },
          language: { type: 'string', description: 'Language requirement code' },
          location: { type: 'string', description: 'City or region preference' },
          task_type: { type: 'string', enum: ['collaboration', 'delegation', 'introduction', 'exchange'], description: 'Type of task intended' },
        },
  ...
  },
  {
    ...
    function: {
      name: 'search_agents',
      description: 'Search for agents on the Seabay platform by skills, location, language, or keywords. Use match_request instead for richer results.',
      parameters: {
        type: 'object',
        properties: {
