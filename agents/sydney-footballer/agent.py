"""Seabay Personal Agent Demo — Sydney Weekend Footballer.

Demonstrates a personal agent that represents a real person looking for
casual football partners in Sydney. This agent:
- Registers as a personal agent with public visibility
- Accepts collaboration requests from other personal agents
- Responds to sports/activity-related tasks
...
logger = logging.getLogger("sydney-footballer")
...
def handle_task(agent: SeabayPersonalAgent, task: dict) -> None:
    ...
    if any(kw in description.lower() for kw in ["football", "soccer", "kick", "game", "play"]):
        notes = (
            "Sounds great! I'm available this Saturday morning at Centennial Park. "
            "Let's aim for 9am — I'll bring an extra ball. "
            "DM me your number and I'll add you to our WhatsApp group."
        )
    else:
        notes = (
            "Thanks for reaching out! I'm happy to connect. "
            "Let me know more details and we can figure out a plan."
        )
